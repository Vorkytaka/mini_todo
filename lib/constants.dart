...
const BorderRadius borderRadiusLarge = BorderRadius.all(Radius.circular(12));

const IconData kDefaultInboxIcon = Icons.inbox_rounded;

const IconData kDefaultFolderIcon = Icons.folder;
